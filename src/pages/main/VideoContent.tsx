...
const VideoContent: React.FC<{}> = () => (
    <GridContent>
      <div style={{ background: '#fafafa', maxHeight: 720, height: 600 }}>
        <RcScrollOverPack
          style={{ maxWidth: 1200, position: 'relative', margin: 'auto', textAlign: 'center' }}
          playScale={0.6}
        >
          <RcTweenOne
            animation={{ opacity: 1 }}
          ...
          >
            <RcQueueAnim
              ...
              leaveReverse
            >
              <div style={{ marginTop: 100 }} key="centent1">
                内容一
              </div>
              <div style={{ marginTop: 20 }} key="centent2">
                内容一
              </div>
              <div style={{ height: 'auto', marginTop: 20, display: 'inline-flex' }} key="centent3">
                {/* eslint-disable-next-line jsx-a11y/media-has-caption */}
                <video
                  poster="https://zos.alipayobjects.com/rmsportal/HZgzhugQZkqUwBVeNyfz.jpg"
