...
import { Card, Col, Divider, Icon, Row, Tooltip as AntdTooltip, Progress, List, DatePicker } from 'antd';
...
class Analysis extends Component<IAnalysisProps, IAnalysisInitState> {
  ...
  render() {
    ...
    const { key, chartSaleAndVisitTitle, listSaleAndVisitTitle, rangeDate } = this.state;
